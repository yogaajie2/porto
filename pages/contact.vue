<template>
  <main>
    ...
    <section class="px-8 py-12 md:px-16 lg:px-24 lg:py-20 xl:px-32">
      ...
      <form action="" class="space-y-8">
        ...
        <button class="block">Send Message</button>
      </form>
    </section>

    <section class="bg-secondary px-8 py-12 text-primary md:px-16 lg:px-24 xl:px-32">
      ...
      >
        <p class="cta border-black mr-4">Book a free discovery call</p>
